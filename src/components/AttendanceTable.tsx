...
import type { Attendance, UIState } from '../types';
import { formatTime, getStatusColor } from '../utils/helpers';

// Import UI state for configuration
import uiStateData from '../mock-data/uiState.json';
...
export const AttendanceTable = ({ attendance }: AttendanceTableProps) => {
  ...
  const uiState = uiStateData as UIState;
  const ITEMS_PER_PAGE = 10; // Could be moved to uiState.json if needed
